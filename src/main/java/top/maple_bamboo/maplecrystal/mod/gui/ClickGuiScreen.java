 ...
 */
package top.maple_bamboo.maplecrystal.mod.gui;
...
import top.maple_bamboo.maplecrystal.mod.gui.items.Component;
import top.maple_bamboo.maplecrystal.mod.gui.items.Item;
...
extends Screen {
    ...
    public ClickGuiScreen() {
        super((Text)Text.literal((String)"MapleCrystal"));
        this.setInstance();
        this.load();
    }
        ...
        for (final Module.Category category : Module.Category.values()) {
            this.components.add(new Component(category.toString(), category, x += 94, 4, true){
                ...
                public void setupItems() {
                    for (Module module : Config.MODULE.getModules()) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Config.BLUR.applyBlur(30.0f, panelX, panelY, panelW, panelH);
        float r = 4.0f;
