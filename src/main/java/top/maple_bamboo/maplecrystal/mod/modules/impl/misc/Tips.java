...
extends Module {
    ...
    public void onAddEntity(EntitySpawnEvent event) {
        ...
        boolean isFriend = MapleCrystal.FRIEND.isFriend(playerName);
    ...
    public void onPlayerDeath(DeathEvent event) {
        ...
        if (this.popCounter.getValue()) {
            if (MapleCrystal.POP.popContainer.containsKey(player.getName().getString())) {
                int l_Count = MapleCrystal.POP.popContainer.get(player.getName().getString());
                if (l_Count == 1) {
    ...
    public void onTotem(TotemEvent event) {
        if (this.popCounter.getValue()) {
            ...
            int l_Count = 1;
            if (MapleCrystal.POP.popContainer.containsKey(player.getName().getString())) {
                l_Count = MapleCrystal.POP.popContainer.get(player.getName().getString());
            }
            if (l_Count == 1) {
                if (player.equals((Object)Tips.mc.player)) {
