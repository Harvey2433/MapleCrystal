...
extends Module {
    ...
    private Module getModuleInstance(String moduleName) {
        try {
            ...
            for (String packageName : possiblePackages = new String[]{"top.maple_bamboo.MapleCrystal.mod.modules.impl.combat.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.movement.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.player.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.render.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.misc.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.client.", "top.maple_bamboo.MapleCrystal.mod.modules.impl.exploit."}) {
                try {
