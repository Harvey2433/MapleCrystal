...
import top.maple_bamboo.maplecrystal.asm.accessors.IContainerComponent;
import top.maple_bamboo.maplecrystal.core.impl.PlayerManager;
import top.maple_bamboo.maplecrystal.mod.gui.PeekScreen;
        ...
        block5: {
            ...
            block4: {
                if (itemStack.getItem() == Items.ENDER_CHEST) {
                    for (int i = 0; i < MapleCrystal.PLAYER.ENDERCHEST_ITEM.size(); ++i) {
                        items[i] = (ItemStack) MapleCrystal.PLAYER.ENDERCHEST_ITEM.get(i);
                    }
                    return;
                }
