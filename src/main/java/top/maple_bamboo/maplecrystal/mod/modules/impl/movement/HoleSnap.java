...
extends Module {
    ...
    public void onEnable() {
        ...
        this.holePos = MapleCrystal.HOLE.getHole((float)this.range.getValue(), true, this.any.getValue(), this.up.getValue());
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (MapleCrystal.HOLE.isDoubleHole(this.holePos) && (facing = MapleCrystal.HOLE.is3Block(this.holePos)) != null) {
