            ...
            if (((int[])equipmentSlotEntry.getValue())[2] < 9) {
                switch (this.hotbarSwap.getValue().ordinal()) {
                    ...
                    case 1: {
                        ...
                        AutoArmor.sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, id, MapleCrystal.ROTATION.getLastYaw(), MapleCrystal.ROTATION.getLastPitch()));
