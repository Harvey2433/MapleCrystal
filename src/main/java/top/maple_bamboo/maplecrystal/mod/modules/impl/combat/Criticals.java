...
import top.maple_bamboo.maplecrystal.mod.modules.impl.exploit.BowBomb;
import top.maple_bamboo.maplecrystal.mod.modules.impl.exploit.Phase;
...
extends Module {
    ...
    public static Entity getEntity(PlayerInteractEntityC2SPacket packet) {
        return Criticals.mc.world == null ? null : Criticals.mc.world.getEntityById(((top.maple_bamboo.maplecrystal.asm.accessors.IPlayerInteractEntityC2SPacket)packet).getEntityId());
    }
