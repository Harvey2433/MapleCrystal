...
import top.maple_bamboo.maplecrystal.api.events.impl.TimerEvent;
...
extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        boolean bl = this.work = !FastWeb.mc.player.isOnGround() && (FastWeb.mc.options.sneakKey.isPressed() || !this.onlySneak.getValue()) && MapleCrystal.PLAYER.isInWeb((PlayerEntity)FastWeb.mc.player);
