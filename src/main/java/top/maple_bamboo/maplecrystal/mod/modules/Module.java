 ...
 */
package top.maple_bamboo.maplecrystal.mod.modules;
...
extends Mod {
    ...
    public void enable() {
        ...
        if (Config.MODULE != null) {
            Config.MODULE.showToggleBanner(this, true);
        }
        this.state = true;
    ...
    public void disable() {
        ...
        if (Config.MODULE != null) {
            Config.MODULE.showToggleBanner(this, false);
        }
        this.state = false;
        Config.EVENT_BUS.unsubscribe(this);
        this.onToggle();
        this.onDisable();
    }
