...
import top.maple_bamboo.maplecrystal.asm.accessors.IFireworkRocketEntity;
...
extends Module {
    ...
    public ElytraFly() {
        ...
        INSTANCE = this;
        MapleCrystal.EVENT_BUS.subscribe(new FireWorkTweak());
    }
    ...
    public void off() {
        ...
        if (ElytraFly.mc.player.getMainHandStack().getItem() == Items.FIREWORK_ROCKET) {
            if (this.packetInteract.getValue()) {
                ElytraFly.sendSequencedPacket(id -> new PlayerInteractItemC2SPacket(Hand.MAIN_HAND, id, MapleCrystal.ROTATION.getLastYaw(), MapleCrystal.ROTATION.getLastPitch()));
            } else {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        float timer = MapleCrystal.TIMER.get();
