...
extends Module {
    ...
    public final StringSetting windowTitle = this.add(new StringSetting("WindowTitle", Config.NAME, () -> this.page.is(Page.Misc) && this.titleOverride.isOpen()));
    ...
    public final StringSetting hackName = this.add(new StringSetting("Notification", "[" + Config.NAME + "]", () -> this.page.getValue() == Page.Notification));
