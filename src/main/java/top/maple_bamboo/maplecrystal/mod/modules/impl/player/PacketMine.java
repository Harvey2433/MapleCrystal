...
import top.maple_bamboo.maplecrystal.mod.modules.impl.combat.CevBreaker;
import top.maple_bamboo.maplecrystal.mod.modules.impl.combat.Criticals;
...
extends Module {
    ...
    float getDigSpeed(BlockState state, ItemStack itemStack) {
        ...
        boolean bl = inWeb = this.checkWeb.getValue() && MapleCrystal.PLAYER.isInWeb((PlayerEntity)PacketMine.mc.player) && PacketMine.mc.world.getBlockState(this.breakPos).getBlock() == Blocks.COBWEB;
