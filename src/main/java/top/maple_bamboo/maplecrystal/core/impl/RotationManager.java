...
import top.maple_bamboo.maplecrystal.mod.modules.impl.movement.HoleSnap;
import top.maple_bamboo.maplecrystal.mod.modules.impl.player.Freecam;
import top.maple_bamboo.maplecrystal.mod.modules.settings.enums.SnapBack;
...
implements Wrapper {
    ...
    public void update(SendMovementPacketsEvent event) {
        if (AntiCheat.INSTANCE.movementSync() && !BaritoneUtil.isActive()) {
            ...
            MapleCrystal.EVENT_BUS.post(updateRotateEvent);
    ...
    public void onLastRotation(UpdateRotateEvent event) {
        ...
        MapleCrystal.EVENT_BUS.post(rotationEvent);
    ...
    public void setLastYaw(float lastYaw) {
        ...
        if (AntiCheat.INSTANCE.forceSync.getValue() && MapleCrystal.SERVER.playerNull.passedS(0.15)) {
