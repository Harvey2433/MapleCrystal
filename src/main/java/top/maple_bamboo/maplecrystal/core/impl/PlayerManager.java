...
import top.maple_bamboo.maplecrystal.api.events.impl.BlockActivateEvent;
import top.maple_bamboo.maplecrystal.api.events.impl.GameLeftEvent;
import top.maple_bamboo.maplecrystal.api.events.impl.OpenScreenEvent;
...
implements Wrapper {
    ...
    public void onUpdate() {
        ...
        this.inWebPlayers.clear();
        for (PlayerEntity playerEntity : MapleCrystal.THREAD.getPlayers()) {
